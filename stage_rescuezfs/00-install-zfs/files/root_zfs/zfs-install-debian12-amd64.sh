...
ZFSDEBDIR=`readlink -f ./zfs-linux-2.2.7-1-debian12-amd64`

#skipped:
# kmod-zfs-6.1.0-28-amd64_2.2.7-1_amd64.deb
# kmod-zfs-devel-6.1.0-28-amd64_2.2.7-1_amd64.deb
# kmod-zfs-devel_2.2.7-1_amd64.deb
# libzfs5-devel_2.2.7-1_amd64.deb
# python3-pyzfs_2.2.7-1_amd64.deb
# zfs-dracut_2.2.7-1_amd64.deb
# zfs-test_2.2.7-1_amd64.deb
# zfs-2.2.7.tar.gz
...
dpkg -i $ZFSDEBDIR/libuutil3_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/libnvpair3_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzfs5_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzpool5_2.2.7-1_amd64.deb
#apt-get install zfs-dkms zfs zfs-initramfs
dpkg -i $ZFSDEBDIR/zfs-dkms_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/pam-zfs-key_2.2.7-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs-initramfs_2.2.7-1_amd64.deb
