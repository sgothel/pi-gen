...
ZFSDEBDIR=`readlink -f ./zfs-linux-2.3.2-1-debian12-amd64`

#skipped:
# kmod-zfs-6.1.0-34-amd64_2.3.2-1_amd64.deb
# kmod-zfs-devel-6.1.0-34-amd64_2.3.2-1_amd64.deb
# kmod-zfs-devel_2.3.2-1_amd64.deb
# libzfs6-devel_2.3.2-1_amd64.deb
# python3-pyzfs_2.3.2-1_amd64.deb
# zfs-2.3.2.tar.gz
...
dpkg -i $ZFSDEBDIR/libuutil3_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/libnvpair3_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzfs6_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzpool6_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs-dkms_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/pam-zfs-key_2.3.2-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs-initramfs_2.3.2-1_amd64.deb
