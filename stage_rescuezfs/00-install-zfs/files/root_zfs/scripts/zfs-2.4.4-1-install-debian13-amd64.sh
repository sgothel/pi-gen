...
ZFSDEBDIR=`readlink -f ./zfs-linux-2.4.4-1-debian13-amd64`

#skipped:
# kmod-zfs-6.12.101+deb13-amd64_2.4.4-1_amd64.deb
# kmod-zfs-devel-6.12.101+deb13-amd64_2.4.4-1_amd64.deb
# kmod-zfs-devel_2.4.4-1_amd64.deb
# libzfs7-devel_2.4.4-1_amd64.deb
# python3-pyzfs_2.4.4-1_amd64.deb
# zfs-2.4.4.tar.gz
# zfs-dracut_2.4.4-1_amd64.deb
# zfs-test_2.4.4-1_amd64.deb
# pam-zfs-key_2.4.4-1_amd64.deb
...
dpkg -i $ZFSDEBDIR/libuutil3_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/libnvpair3_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzfs7_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/libzpool7_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs-dkms_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs_2.4.4-1_amd64.deb
dpkg -i $ZFSDEBDIR/zfs-initramfs_2.4.4-1_amd64.deb
...
apt-mark manual zfs-initramfs zfs zfs-dkms libzfs7 libzpool7 libuutil3 libnvpair3
