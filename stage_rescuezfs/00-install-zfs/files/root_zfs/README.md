...
for GNU/Linux version [2.4.4](https://github.com/openzfs/zfs/releases/tag/zfs-2.4.4).
...
cd zfs
git checkout -b b_zfs-2.4.4 zfs-2.4.4
cd ..
```
...
cd zfs
git checkout -b b_zfs-2.4.4_debian13 --track origin/b_zfs-2.4.4_debian13
cd ..
```
...
sh scripts/zfs-install-debian13-amd64.sh
...
```
dkms install zfs/2.4.4 -k 6.12.90+deb13.1-amd64
```
